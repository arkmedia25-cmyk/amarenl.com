      ...
      <body className="antialiased min-h-screen flex flex-col font-nunito">
        ...
        <Script id="meta-pixel-init" strategy="afterInteractive">
          {`
            ...
            fbq('init', '${process.env.NEXT_PUBLIC_META_PIXEL_ID || "PLACEHOLDER"}');
            fbq('track', 'PageView');
          `}
        </Script>
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src={`https://www.facebook.com/tr?id=${process.env.NEXT_PUBLIC_META_PIXEL_ID || "PLACEHOLDER"}&ev=PageView&noscript=1`}
            alt=""
          />
        </noscript>
