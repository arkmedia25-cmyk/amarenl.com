...
const faqs = [
  ...
  },
  {
    ...
    answer: "Basic (€277,68/maand) = voordeligste instap, essentiële producten. Triangle (€399/maand) = 3x sets om te delen, perfect voor social media. Pro (€649,64/maand) = volledig assortiment, hoogste commissie. Laat je gegevens achter, dan helpen we je persoonlijk kiezen."
  },
  {
