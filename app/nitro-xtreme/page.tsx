...
export default function NitroXtremePage() {
  ...
  const img = product?.images?.primary || "/images/products/nitro-xtreme.jpg";
  ...
  return (<>
    ...
    <section className="py-16 bg-[var(--color-bg-soft)]"><div className="container-page max-w-3xl">
      ...
      <p className="mt-4 text-xs text-[var(--color-text-muted)]">Bron: officieel <a href="https://amarecdn.azureedge.net/webassets/resources/productinfo/NL/Nitro-ProductFactsheet-NL.pdf" target="_blank" rel="nofollow noopener noreferrer" className="underline hover:text-[var(--color-primary)]">Amare-productinformatieblad (PDF)</a>.</p>
    </div></section>
