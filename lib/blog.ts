...
export const blogPosts: BlogPost[] = [
{
    ...
    author: "Mark",
    citations: [{ author: "Morton RW, et al.", name: "British Journal of Sports Medicine (2018)", url: "https://doi.org/10.1136/bjsports-2017-097608" }, { author: "Gorissen SHM, et al.", name: "Amino Acids (2018)", url: "https://doi.org/10.1007/s00726-018-2640-5" }, { author: "Jäger R, et al.", name: "Journal of the International Society of Sports Nutrition (2017)", url: "https://doi.org/10.1186/s12970-017-0177-8" }],
    content: `
      ...
      <p>Ben je een man boven de 30 en wil je naast spierherstel via eiwit ook je huid en gewrichten ondersteunen? Lees ons artikel over <a href="/blogs/nieuws/collageen-mannen-30-huid-gewrichten-spierherstel">collageen voor mannen boven de 30</a> — collageenpeptiden werken op het bindweefsel rond je gewrichten, een ander mechanisme dan de spiereiwitsynthese die een eiwitshake ondersteunt.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/sunset">Amare Sunset</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
  ...
  },
{
    ...
    content: `
      ...
      <p>De meest evidence-based aanpak combineert drie routes: 1. <strong>Psychobiotica</strong> (MentaBiotics, €71,83/maand) voor lange-termijn stressmodulatie via de gut-brain axis — dit pakt de onderliggende fysiologie van chronische stress aan 2. <strong>Adaptogenen</strong> (losse ashwagandha, ~€20/maand) voor dagelijkse stressbestendigheid en cortisolregulatie, of <strong>EDGE+</strong> (€77,28/maand) voor mentale scherpte via mangoblad-extract, goji, Boswellia serrata en Terminalia chebula 3. <strong>Magnesium</strong> (~€10/maand) voor zenuwstelsel-kalmering en slaapkwaliteit</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/gut-brain-axis">gut brain axis</a>.</p>
    `,
  ...
  },
{
    ...
    content: `
      ...
      <tr><td>EDGE+ (Amare)</td><td>Plantaardig focus-supplement</td><td>Mangoblad-extract, goji, Boswellia serrata, Terminalia chebula</td><td>Mentale focus + minder stress-eten</td><td>€77,28</td></tr>
      ...
      <p><strong>EDGE+</strong> richt zich primair op focus en mentale energie via mangoblad-extract, goji, Boswellia serrata en Terminalia chebula. Die focus vertaalt zich praktisch naar: meer energie om te trainen, minder stress-eten, betere beslissingen over voeding. Dat maakt het relevant voor iedereen die afvallen lastig vindt door energiegebrek of stress-snacken.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/edge-plus">Amare EDGE+</a> · <a href="/hl5">Amare HL5</a> · <a href="/gewichtsbeheer">gewichtsbeheer</a>.</p>
    `,
    image: "/images/products/restore.jpg"
  },
{
    ...
    content: `
      ...
      <p>De collageenmarkt is explosief gegroeid — van supermarktschap tot premium merken, allemaal met claims over huid, haar en nagels. De basis (wat collageen is, type 1 versus 3, waarom gehydrolyseerd collageen beter opneembaar is) leggen we uit in onze <a href="/blogs/nieuws/vloeibaar-collageen-hl5-huid-haar-nagels">complete gids over collageen</a>. Hier vergelijken we concreet HL5, NeuCollagen en een aantal bekende budgetopties op dosering, type, vorm en prijs per gram — zodat je weet waar je voor betaalt.</p>
      ...
      <tr><td>HL5 (Amare)</td><td>Type 1&3 (runder)</td><td>5g</td><td>Vloeibaar</td><td>FOS, appelciderazijn</td><td>€130,42</td><td>€0,43</td></tr>
      ...
      <p>Voor de huid is een gehydrolyseerd collageen Type 1&3 supplement met minimaal 5 gram per dag de beste keuze. HL5 voldoet aan deze criteria — vloeibaar voor snelle opname, aangevuld met fructo-oligosachariden en appelciderazijnpoeder. NeuCollagen is een alternatief als je naast huid ook gewrichten en stressrespons wilt ondersteunen. In het budgetsegment zijn Lucovitaal en Orthica redelijke keuzes — controleer wel of de verpakking "gehydrolyseerd" vermeldt.</p>
      ...
      <p><strong>Voor pure huid-, haar- en nagelondersteuning</strong> is HL5 (€130,42/maand) de meest complete keuze: 5 gram gehydrolyseerd rundercollageen Type 1&3 in een kant-en-klaar vloeibaar sachet. De prijs is hoog, maar je koopt een klinisch relevante dosering met tot 90% opname.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/collageen-poeder">collageen poeder</a>.</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>Supermarktcollageen bevat vaak maltodextrine (een goedkope vulstof) en antiklontermiddelen. HL5 heeft naast het collageen fructo-oligosachariden (prebiotische vezel), appelciderazijnpoeder, natuurlijke smaakstoffen (Berry of Peach) en stevia — geen maltodextrine of antiklontermiddelen. Dit is relevant omdat je een supplement dagelijks neemt — wat je erbij binnenkrijgt telt op.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/hl5">Amare HL5</a> · <a href="/edge-plus">Amare EDGE+</a> · <a href="/collageen-poeder">collageen poeder</a>.</p>
    `,
    image: "/images/products/hl5.jpg"
  },
  {
    ...
    content: `
      ...
      <p>EDGE+ is het meest geavanceerde product in de bundel. Het combineert mangoblad-extract, goji, Boswellia serrata en Terminalia chebula — plantaardige ingrediënten gericht op mentale scherpte en veerkracht zonder overprikkeling.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/edge-plus">Amare EDGE+</a> · <a href="/mentabiotics">Amare MentaBiotics</a> · <a href="/pakketten">pakketten</a>.</p>
    `,
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunset">Amare Sunset</a> · <a href="/hl5">Amare HL5</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/Amare-Mentabiotics-EU-800.jpg"
  },
  {
    ...
    content: `
      ...
      <p>De cijfers liegen er niet om: volgens marktonderzoek kiest inmiddels 34% van de Nederlandse eiwitshakegebruikers voor een plantaardige variant als hoofdshake — een verdubbeling ten opzichte van 2021. De drijfveren zijn divers: lactose-intolerantie (een groot deel van de wereldbevolking verteert lactose slecht), milieubewustzijn, een flexitarisch eetpatroon, of simpelweg de ontdekking dat een goed samengestelde plantaardige shake prettiger verteert dan whey.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/nitro-xtreme">Amare Nitro Xtreme</a> · <a href="/triangle-of-wellness-xtreme">Triangle of Wellness Xtreme</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
    image: "/images/products/restore.jpg"
  },
  {
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/restore">Amare Restore</a> · <a href="/sunrise">Amare Sunrise</a> · <a href="/beste-probiotica">beste probiotica</a>.</p>
    `,
    image: "/images/products/restore.jpg"
  },
  {
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunset">Amare Sunset</a> · <a href="/hl5">Amare HL5</a> · <a href="/supplementen">supplementen</a>.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>De beste benadering is geen of/of maar en/en: een ochtendkoffie voor directe alertheid, aangevuld met een focus-supplement voor duurzame, kalme focus. <strong>Amare EDGE+</strong> (Mango-variant met 75 mg cafeïne, Watermelon-variant cafeïnevrij) combineert mangoblad-extract, goji, Boswellia serrata en Terminalia chebula, en biedt zo een keuze tussen wel of geen extra cafeïne naast je koffie.</p>
      ...
      <p><strong>Amare EDGE+</strong> combineert mangoblad-extract, goji, Boswellia serrata en Terminalia chebula in één dagelijkse portie (Mango-variant met 75 mg cafeïne, Watermelon-variant cafeïnevrij). De formule is ontworpen voor mentale focus, en wordt ondersteund door Amare's kwaliteitsgarantie op iedere batch.</p>
      ...
      <p>De meest onderbouwde benadering combineert adaptogenen (om de stressrespons te dempen), neurotransmitterprecursoren (om de bouwstenen voor focus te leveren) en doorbloedingsverbeteraars (om zuurstof en glucose naar de prefrontale cortex te brengen). <strong>Amare EDGE+</strong> met mangoblad-extract, goji, Boswellia serrata en Terminalia chebula is een praktisch alternatief voor wie geen losse ingrediënten wil combineren.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/edge-plus">Amare EDGE+</a> · <a href="/hl5">Amare HL5</a> · <a href="/gut-brain-axis">gut brain axis</a>.</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p><strong>Amare HL5</strong> bevat 5 gram gehydrolyseerd rundercollageen type 1 en 3 per dagelijkse portie in een vloeibare, voorverteerde vorm, aangevuld met fructo-oligosachariden en appelciderazijnpoeder. Deze aminozuurbouwstenen ondersteunen niet alleen de hoofdhuid, maar het geheel van huid, haar en nagels — een benadering die logisch is vanuit de biologie: dezelfde weefsels delen dezelfde bouwstenen.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/sunset">Amare Sunset</a> · <a href="/schoonheid">schoonheid</a>.</p>
    `,
    image: "/images/products/hl5.jpg"
  },
  {
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/sunset">Amare Sunset</a> · <a href="/darmgezondheid">darmgezondheid</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/HJ_mango-EU-800_25.jpg"
  },
  {
    ...
    content: `
      ...
      <p>Adaptogenen komen tot hun recht in combinatie. Ashwagandha werkt synergetisch met Rhodiola rosea (cognitieve prestaties onder druk) en L-theanine (ontspannen alertheid). <strong>Amare EDGE+</strong> is een ander plantaardig focus-supplement — het combineert mangoblad-extract, goji, Boswellia serrata en Terminalia chebula in één formule. Een multi-component benadering kan effectiever zijn dan een enkelvoudig kruidensupplement.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/edge-plus">Amare EDGE+</a> · <a href="/energy">Amare Energy+</a> · <a href="/adaptogenen">adaptogenen</a>.</p>
    `,
  ...
  },
  {
    ...
    author: "Mark",
    content: `
      <h2>Collageen kopen: waar begin je?</h2>
      <p>Het aanbod collageen supplementen is overweldigend. Wat collageen precies is, het verschil tussen type 1 en 3, en waarom gehydrolyseerd collageen beter opneembaar is, leggen we uit in onze <a href="/blogs/nieuws/vloeibaar-collageen-hl5-huid-haar-nagels">complete gids over collageen</a> — inclusief het onderzoek naar huid- én nagelverbetering. Hier gaan we verder: wat let je precies op bij het kopen, welke vorm past bij jou, en wat kost een goed collageen supplement echt?</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/hl5">Amare HL5</a> · <a href="/mentabiotics">Amare MentaBiotics</a> · <a href="/collageen-poeder">collageen poeder</a>.</p>
    `,
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/restore">Amare Restore</a> · <a href="/mentabiotics">Amare MentaBiotics</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/Amare-Mentabiotics-EU-800.jpg"
  },
  {
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/triangle-of-wellness-xtreme">Triangle of Wellness Xtreme</a> · <a href="/sunrise">Amare Sunrise</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
  ...
  
  {
    ...
    title: "IJzertekort en Vermoeidheid: Symptomen en Wat Helpt",
    date: "2026-04-10",
    category: "Energie",
    ...
    content: `
      ...
      <p>Wist je dat vitamine C de opname van ijzer uit je voeding aanzienlijk verbetert? Neem je bij een ijzerrijke maaltijd (rood vlees, peulvruchten, spinazie) ook vitamine C, dan haal je er meer uit.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunset">Amare Sunset</a> · <a href="/hl5">Amare HL5</a> · <a href="/gewichtsbeheer">gewichtsbeheer</a>.</p>
    `,
    image: "/images/products/restore.jpg"
  },
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/nitro-xtreme">Amare Nitro Xtreme</a> · <a href="/triangle-of-wellness-xtreme">Triangle of Wellness Xtreme</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
    image: "/images/products/nitro-xtreme.jpg"
  },
  {
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/edge-plus">Amare EDGE+</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/Sunrise-2pk-EU-800.jpg"
  },
  {
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunset">Amare Sunset</a> · <a href="/energy">Amare Energy+</a> · <a href="/schoonheid">schoonheid</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/Sunset-EU-800.jpg"
  },
  {
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/mentabiotics">Amare MentaBiotics</a> · <a href="/nitro-xtreme">Amare Nitro Xtreme</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/Sunrise-2pk-EU-800.jpg"
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li><strong>Energy+ (30 sachets):</strong> Natuurlijke energie zonder cafeïnecrash. Bevat cafeïne (~27,6 mg per portie), gecombineerd met L-glycine en vitamine C, plus plantenextracten van druivenpit, framboos, maritieme dennenschors en granaatappel. Milde energie zonder de scherpe piek-en-dal van een kop koffie.</li>
        <li><strong>Amare EDGE+ (30 sachets, keuze Mango of Watermelon):</strong> Een plantaardig supplement dat mentale scherpte en focus ondersteunt. Bevat mangoblad-extract, goji, Boswellia serrata, Terminalia chebula en pantotheenzuur (vitamine B5). De Mango-variant bevat 75 mg cafeïne per stickpack, de Watermelon-variant is cafeïnevrij.</li>
      </ul>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/edge-plus">Amare EDGE+</a> · <a href="/mentabiotics">Amare MentaBiotics</a> · <a href="/gut-brain-axis">gut brain axis</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/HJ_mango-EU-800_25.jpg"
  },
  {
    ...
    content: `
      ...
      <p>Sunrise is ontworpen om je dag te starten met een breed spectrum aan micronutriënten uit <strong>22 verschillende superfoods</strong>, waaronder bosbes, blauwe bes, Canadese bosbes, framboos, aronia, cranberry, açaibes, granaatappel en mangosteen. Daarnaast bevat het 9 vitamines (het volledige B-complex plus vitamine C).</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/sunset">Amare Sunset</a> · <a href="/pakketten">pakketten</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/Triangle-of-Wellness-Xtreme2-EU-800_25.jpg"
  },
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>Fructo-oligosachariden (FOS):</strong> een prebiotische vezel die als voeding dient voor de goede bacteriën in je darmen.</li>
        <li><strong>Appelciderazijnpoeder:</strong> gemaakt van appels (Malus domestica), onderdeel van de formule.</li>
      </ul>
      <p>Eiwit — de bouwsteen waar collageen uit bestaat — draagt volgens de Europese Voedselveiligheidsautoriteit (EFSA) bij aan de groei en het behoud van spiermassa, en aan het behoud van normale botten.</p>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/hl5">Amare HL5</a> · <a href="/collageen-poeder">collageen poeder</a>.</p>
    `,
    image: "/images/products/hl5-2pack.jpg"
  },
  {
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/sunset">Amare Sunset</a> · <a href="/pakketten">pakketten</a>.</p>
  ...
  },
  {
    ...
    author: "Mark",
    citations: [{ author: "Yano JM, et al.", name: "Cell (2015)", url: "https://doi.org/10.1016/j.cell.2015.02.047" }],
    content: `
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/sunset">Amare Sunset</a> · <a href="/pakketten">pakketten</a>.</p>
  ...
  },
  {
    ...
    title: "Altijd Moe? Zo Bepaalt Cel-Energie Dit",
    date: "2025-01-20",
    category: "Dagelijkse Essentials",
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/restore">Amare Restore</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/Amare-Energy-Dragonfruit-EU-800.jpg"
  },
  {
    slug: "apotheek-of-groenteboer",
    title: "Apotheek of Groenteboer: Wat Kies Jij?",
    date: "2024-11-15",
    category: "Lifestyle & Wellness",
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/mentabiotics">Amare MentaBiotics</a> · <a href="/edge-plus">Amare EDGE+</a> · <a href="/supplementen">supplementen</a>.</p>
    `,
    image: "https://amarecdn.azureedge.net/webassets/web/prod/products/Amare-Mentabiotics-EU-800.jpg"
  },
{
    ...
    author: "Mark",
    citations: [{ author: "Hexsel D, et al.", name: "Journal of Cosmetic Dermatology (2017)", url: "https://doi.org/10.1111/jocd.12393" }],
    content: `
      ...
      <tr><td><strong>Sunrise</strong></td><td>Vitamine C + volledig B-complex (incl. biotine)</td><td>Micronutriëntenbasis voor haar</td></tr>
      </table>
      ...
      <h2>Wij hebben het getest — eerlijk over wat we zelf merkten</h2>
      <p>Mijn nagels scheurden altijd bij het minste of geringste. Vijftien jaar lang dacht ik: "het zit in de familie, niks aan te doen." Toen ik twee jaar geleden serieus met collageen begon — elke ochtend 5 gram HL5 in mijn koffie — en tegelijk mijn eiwitinname verhoogde, veranderde alles. Na drie maanden waren mijn nagels voor het eerst hard genoeg om niet te splijten bij het openen van een blikje tomaten. Klein detail, groot verschil.</p>
      <p><strong>Collageen werd in 2025 uitgeroepen tot Supplement van het Jaar</strong> door branchevereniging NPN — niet vreemd als je bedenkt dat ruim 72% van de Nederlandse volwassenen inmiddels supplementen gebruikt. De collageenverkoop steeg met dubbele cijfers in 2025 en zet die lijn in 2026 onverminderd door. De reden? Het is een van de weinige supplementen waar je resultaat letterlijk kunt zíen — aan je nagels, niet aan een abstract lab-cijfer.</p>
      <p>We testten HL5 (collageen), Sunrise (micronutriënten) en de combinatie bij vier teamleden met verschillende uitdagingen: van broze nagels tot dunner wordend haar na de zwangerschap. Drie van de vier zagen binnen 8 weken zichtbaar verschil. De vierde had een niet-gediagnosticeerde trage schildklier — die moest eerst behandeld worden voor supplementen zin hadden. Een belangrijke les: check de basis eerst.</p>
      <p><strong>Heb jij collageen al eens geprobeerd?</strong> En zo ja: na hoeveel weken merkte je het eerste verschil — of twijfel je nog? Laat het ons weten, we lezen elke reactie.</p>
      <h2>Veelgestelde vragen</h2>
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunrise">Amare Sunrise</a> · <a href="/hl5">Amare HL5</a> · <a href="/schoonheid">schoonheid</a>.</p>
    `,
    image: "/images/products/hl5.jpg"
  },
...
Amare heeft geen standalone magnesiumsupplement. <strong>MentaBiotics</strong> bevat 56,25 mg magnesium(oxide) per portie (15% RI) — een bescheiden hoeveelheid, en oxide is niet de best opneembare vorm (zie hierboven). Voor een gerichte magnesiumkuur is een los supplement met citraat, bisglycinaat of tauraat een betere keuze dan op Amare's productenlijn te vertrouwen.
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/nitro-xtreme">Amare Nitro Xtreme</a> · <a href="/sunrise">Amare Sunrise</a> · <a href="/supplementen">supplementen</a>.</p>
    `},
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/restore">Amare Restore</a> · <a href="/edge-plus">Amare EDGE+</a> · <a href="/gewichtsbeheer">gewichtsbeheer</a>.</p>
    `},
  {
    ...
    author: "Mark",
    citations: [
      { author: "Abdou AM, Higashiguchi S, Horie K, Kim M, Hatta H, Yokogoshi H", name: "Relaxation and immunity enhancement effects of gamma-aminobutyric acid (GABA) administration in humans (BioFactors, 2006)", url: "https://doi.org/10.1002/biof.5520260305" },
    ],
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/mentabiotics">Amare MentaBiotics</a> · <a href="/edge-plus">Amare EDGE+</a>.</p>
    `
  },
  {slug:"omega-3-hersenen-cognitie-supplement-wetenschap",title:"Omega-3: Waarom Hebben Hersenen Dit Nodig?",date:"2026-06-23",category:"mentaal",excerpt:"Je hersenen bestaan voor bijna 60% uit vet — en een groot deel daarvan is omega-3 DHA. Toch krijgt het gros van de Nederlanders te weinig binnen. Dit is wat de wetenschap zegt over omega-3, cognitie en stemming.",author: "Mark",
    citations: [
...
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/sunset">Amare Sunset</a> · <a href="/energy">Amare Energy+</a> · <a href="/omega-3-supplement">omega 3 supplement</a>.</p>
    `},
  ...
  
  {
    ...
    title: "6 Maanden Collageen Slikken: Mijn Ervaring",
    date: "2026-06-30",
    category: "schoonheid",
    excerpt: "Ik slikte 6 maanden collageen en hield een dagboek bij. Dit is wat er écht gebeurde met mijn huid, haar en nagels.",
    content: `<p>Collageen is hip. Je ziet het overal. Op Instagram, TikTok, in de drogist. Poeders, pillen, drankjes. Het belooft je een stralende huid, minder rimpels, sterker haar. Maar werkt het ook?</p><p>Ik heb het zes maanden getest. Elke dag. Met een dagboek. Dit is wat er gebeurde.</p><h2>Waarom ik begon</h2><p>Ik ben 34. Mijn huid is oké, maar ik begon het te zien. Fijne lijntjes bij mijn ogen. Mijn haar viel meer uit in de douche dan een paar jaar geleden. En mijn nagels braken als ik ze ook maar verkeerd aankeek. Van een vriendin hoorde ik over collageen supplementen. Zij zweerde erbij. Ik was sceptisch. Maar ik was ook nieuwsgierig.</p><h2>Maand 1: Niks</h2><p>Eerste maand: ik merkte niks. Geen stralende huid. Geen sterkere nagels. Ik nam elke dag braaf mijn portie, mengde het door mijn ochtendkwark, en wachtte. Sommige mensen zeggen dat je na twee weken al resultaat ziet. Bij mij dus niet.</p><h2>Maand 2-3: Nagels!</h2><p>Het eerste wat ik merkte, waren mijn nagels. Rond week zes brak er eentje niet. En daarna nog een niet. Na drie maanden had ik voor het eerst in jaren nagels die ik kon lakken zonder dat er binnen twee dagen een punt afbrak. Dat was het moment dat ik dacht: oké, misschien doet dit toch íets.</p><p>Mijn haar werd ook minder dun. Het viel nog steeds uit — dat is normaal — maar niet meer bij bosjes. En de nieuwe haren die terugkwamen leken dikker.</p><h2>Maand 4-5: Huid</h2><p>Pas na vier maanden zag ik verschil in mijn huid. Niet van die dramatische voor-en-na foto's die je op Instagram ziet. Maar de fijne lijntjes bij mijn ogen waren minder diep. Mijn huid voelde soepeler aan. Iemand zei op een verjaardag: 'Je ziet er goed uit, ben je op vakantie geweest?' Dat was het moment.</p><h2>Maand 6: Conclusie</h2><p>Werkt collageen? Ja. Maar niet zoals op Instagram. Het is geen filter. Het is geen wonder. Het is een langzaam proces dat maanden duurt. Wat ik heb geleerd:</p><ol><li>Je hebt geduld nodig. Minstens 3 maanden voor nagels, 4-5 voor huid.</li><li>Niet elk collageen is hetzelfde. Goedkope poeders uit de supermarkt deden bij mij niks. Pas toen ik overstapte op een vloeibaar hydrolysaat — HL5 — zag ik verschil.</li><li>Je moet het élke dag nemen. Echt elke dag. Anders werkt het niet.</li></ol><h2>Mijn aanbeveling na 6 maanden</h2><p>Als je het geld hebt en je wilt het proberen: kies een gehydrolyseerd collageen met Type 1&3 en vitamine C. Geen pillen — poeder of vloeibaar. En geef het minstens 3 maanden. Na 6 maanden had ik nagels die niet braken, haar dat voller was, en iemand die vroeg of ik op vakantie was geweest. Dat is voor mij genoeg bewijs.</p><p><em>* Voedingssupplement. Geen geneesmiddel.</em></p>
<h2>Gerelateerde producten & categorieën</h2><p>Meer lezen: <a href="/hl5">Amare HL5</a> · <a href="/mentabiotics">Amare MentaBiotics</a> · <a href="/collageen-poeder">collageen poeder</a>.</p>
    `
  },
  {
...
"foliumzuur-tekort-signalen-en-adh": [
    { name: "Amare Sunrise", url: "/sunrise", isInternal: true, price: "€85,78/maand", tagline: "22 superfoods en 9 vitamines waaronder foliumzuur, B12 en B1-B6 in één ochtendformule" },
...
"beste-collageen-supplement-2026-werkt-echt": [
    ...
    { name: "Amare HL5", url: `${AFFILIATE_BASE}/hl5-peach-2pack`, isInternal: false, price: "€130,42/maand", tagline: "5g gehydrolyseerd rundercollageen + FOS + appelciderazijn in één vloeibaar sachet" },
  ...
  "beste-supplementen-haar-nagels-werkt-echt": [
    { name: "HL5", url: "/hl5", isInternal: true, price: "€130.42/maand", tagline: "5g gehydrolyseerd collageen Type 1&3 — 2-pack beste waarde" },
    { name: "Amare HL5", url: "/hl5", isInternal: true, price: "€130.42/maand", tagline: "5g rundercollageen peptiden + FOS + appelciderazijn — haar & nagels" },
    ...
    { name: "Sunrise", url: "/sunrise", isInternal: true, price: "€85.78/maand", tagline: "Vitamine C + volledig B-complex — complete basis" },
  ],
