...
<p><em>Bronnen: Gezondheidsraad (2015); EFSA (2012); Liao et al. (2019) Translational Psychiatry; Morris et al. (2003) Archives of Neurology; Grosso et al. (2014) PLoS ONE.</em></p>`}
  ...
  {slug:"collageen-poeder-kopen-waar-op-letten",title:"Collageen Poeder Kopen: Alles Wat Je Moet Weten (2026)",date:"2026-06-23",category:"schoonheid",excerpt:"Collageen poeder is booming. Welk type heb je nodig? Hydrolysaat vs gelatine, Type 1 vs Type 2, dosering en kwaliteit.",content:`<h2>Waarom collageen?</h2><p>Collageen is je meest voorkomende eiwit. Vanaf je 25e verlies je 1% per jaar. Poeder wint van pillen: effectieve dosis is 5-10g, pillen bevatten maar 500mg per stuk. Gehydrolyseerd collageen is voorverteerd — betere opname.</p><p><strong>Amare HL5</strong> combineert 5 typen collageen (I, II, III, V, X) in 5g per dagelijkse portie — huid, haar, nagels én gewrichten in één formule. Met toegevoegde vitamine C als co-factor voor collageensynthese.</p><p>Let bij kopen op: hydrolysaat (niet gelatine), grasgevoerd, minimaal Type I+III, en altijd met vitamine C voor opname.</p><p><em>* Voedingssupplement. Geen geneesmiddel.</em></p>`},
  {slug:"beste-probiotica-supplement-2026-vergelijken",title:"Beste Probiotica Supplement 2026: Waar Je Op Moet Letten",date:"2026-06-23",category:"darmen",excerpt:"Niet elke probiotica is hetzelfde. CFU's, stammen, maagsapresistentie — wij leggen uit waar je op moet letten.",content:`<h2>Probiotica is niet één ding</h2><p>Meer CFU is niet altijd beter. Een supplement met 1 miljard CFU van de juiste stammen werkt beter dan 50 miljard van de verkeerde. Waar het om draait is stamspecificiteit en overleving in je darmen.</p><p>Voor stemming en stress: <strong>Lactobacillus rhamnosus</strong> en <strong>Bifidobacterium longum</strong>. Voor darmbarrière: <strong>Lactobacillus plantarum</strong>. Voor ontstekingsremming: <strong>Bifidobacterium breve</strong>.</p><p>Amare's <strong>MentaBiotics</strong> gebruikt de gepatenteerde Cerebiome® blend — klinisch onderzocht op stemming en stress. <strong>Restore</strong> combineert 5 stammen met 5 spijsverteringsenzymen voor dagelijkse darmondersteuning.</p><p>Probiotica zijn de zaadjes, prebiotica de mest — je hebt beide nodig voor optimale darmgezondheid.</p><p><em>* Voedingssupplement. Geen geneesmiddel.</em></p>`},
  {slug:"omega-3-supplement-kopen-alles-wat-je-moet-weten",title:"Omega 3 Supplement Kopen: Complete Gids voor EPA, DHA en ALA",date:"2026-06-23",category:"essentials",excerpt:"Omega 3 is een van de best onderzochte supplementen ter wereld. Visolie, algenolie, EPA, DHA — wat heb je nodig?",content:`<h2>De belangrijkste vetzuren voor je lichaam</h2><p>ALA (plantaardig, uit lijnzaad) moet je lichaam omzetten naar EPA en DHA — slechts 5-15% efficiënt. EPA is ontstekingsremmend en ondersteunt hartgezondheid. DHA is cruciaal voor hersenfunctie — 20% van je brein bestaat uit DHA.</p><p>Visolie is de klassieker maar heeft nadelen: zware metalen, microplastics, visachtige nasmaak. Algenolie is de duurzame, veganistische variant — vissen halen hun omega 3 immers uit algen.</p><p>Amare's <strong>Sunset</strong> gebruikt algenolie als bron van DHA en EPA — 1000mg per portie in een uitgebalanceerde verhouding. Plus vitamine D3 en K2 voor optimale opname en botgezondheid.</p><p>Dosering: ADH is 200mg/dag. Therapeutisch: 1000mg voor hart, 1000-2000mg EPA voor stemming. Let bij kopen op TOTOX-waarde (versheid, <20 is goed) en zware metalen-test.</p><p><em>* Voedingssupplement. Geen geneesmiddel. Raadpleeg een arts bij medicijngebruik.</em></p>`}
];
