...
|------------|---------------------------|-------------|--------------------|-------------|
| MentaBiotics (Amare) | Psychobiotica (L. helveticus, B. longum), prebiotica | ondersteunt mentale veerkracht en stressrespons (volgens gebruikerservaringen) via gut-brain axis, ondersteunt stemming | 3-4 weken | €71,83 |
